...
bool Spreadsheet::readFile(const QString &fileName)
{
    ...
    if (magic != MagicNumber){
        QMessageBox::warning(this, "Spreadsheet", tr("this is not a vaild spreadsheet file"));
        return false;
    }
...
//
// To ensure only one range is ever returned. Technically, this should be
// protected by ContiguousSelection mode but this will protect against any other bugs.
//
...
void Spreadsheet::paste()
{
    ...
    if ((range.rowCount() * range.columnCount() != 1) &&
        ...
        QMessageBox::information(this, tr("Spreadsheet"),
                                 "Pasting selection range is not equal to copy selection range");
        return;
    }
...
void Spreadsheet::findNext(const QString &str, Qt::CaseSensitivity cs)
{
    ...
    QApplication::beep();
    int res = QMessageBox::question(this, tr("Spreadsheet"),
